...
get = Button(frame, text='Добавить в съеденное', command=get_product, state=DISABLED)
get_menu = Button(frame, text='Съеденное сегодня', command=get_menu)
todays_statistics = Label(frame, text=f'Сегодня:\n Белки: {protein}\nЖиры: {fat}\nУглеводы: {carb}\nКкал: {ccal}', bg='pink')
warning = Label(frame, text='Будте внимательны\n при добавлении продуктов!\n Из съеденного удалить нельзя!', bg='pink')
...
weightField.pack()
todays_statistics.place(x=550, y=5)
btn.place(x=233, y=150, anchor='s')
get.place(x=355, y=150, anchor='s')
get_menu.place(x=505, y=150, anchor='s')
